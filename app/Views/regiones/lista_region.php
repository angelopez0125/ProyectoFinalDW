...
<body>
    ...
    <h1>Regiones</h1>
    <a href="<?=base_url('ver_formulario_nuevo_region')?>">
    ...
    <table>
        ...
        <tbody>
            ...
            <!-- <tr> este elemento lo creare en las condicionantes para cambiar color -->
                ...
                <td>
                    <a href="<?=base_url('frm_modificar_region/'.$datos['cod_region'])?>">
                        <span class="material-icons">edit</span>Actualizar
                    </a>
                     
                    <a href="<?=base_url('eliminar_region/'.$datos['cod_region'])?>">
