...
<body>
    ...
    <a href="<?=base_url('ver_formulario_nuevo_tipo')?>">
    ...
    <table>
        ...
        <tbody>
            ...
            <!-- <tr> este elemento lo creare en las condicionantes para cambiar color -->
                <td><?php echo $datos['tipousuario_id']; ?></td>
                <td><?=$datos['nombre']; ?></td>
                <td><?=$datos['observaciones']; ?></td>
                <td>
                    <a href="<?=base_url('frm_modificar_tipo/'.$datos['tipousuario_id'])?>">
                        <span class="material-icons">edit</span>Actualizar
                    </a>
                     
                    <a href="<?=base_url('eliminar_tipo/'.$datos['tipousuario_id'])?>">
